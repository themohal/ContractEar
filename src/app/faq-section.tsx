...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "All sales are final once analysis results have been delivered. If a refund is approved, the cost of any delivered analyses will be deducted as per your plan rate (Pay Per Use: $3.99, Basic: $1.45, Pro: $1.58 per analysis). Support contributions are non-refundable. All refund requests are handled by Lemon Squeezy, our payment processor. Use the link in your Lemon Squeezy receipt email or visit lemonsqueezy.com/help to submit a request. See our refund policy for full details.",
  },
  {
